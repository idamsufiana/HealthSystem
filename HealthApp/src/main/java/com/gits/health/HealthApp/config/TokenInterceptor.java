...
import com.gits.health.HealthApp.exception.GitsException;
import com.gits.health.HealthApp.exception.ResourceForbiddenException;
import com.gits.health.HealthApp.exception.UnauthorizedException;
    ...
    public boolean preHandle(HttpServletRequest request, @NonNull HttpServletResponse response, @NonNull Object handler) throws Exception {
        try {
            ...
            if (exp.getTime() < Calendar.getInstance().getTimeInMillis()) {
                throw new GitsException(404, expired);
            }
